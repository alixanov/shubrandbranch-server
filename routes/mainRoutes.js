...
router.post('/master', authMiddleware.verifyToken, masterController.createMaster);

// Barcha ustalarni olish
router.get('/masters', authMiddleware.verifyToken, masterController.getMasters);

// Ustaga mashina qo‘shish
router.post('/master/:master_id/car', authMiddleware.verifyToken, masterController.createCarToMaster);

// Ustaning mashinasiga savdo (sale) qo‘shish
router.post('/master/:master_id/car/:car_id/sale', authMiddleware.verifyToken, masterController.createSaleToCar);
